...
namespace EventManager.Logic.Controllers
{
	internal abstract partial class GenericController<C, E> : ControllerObject, EventManager.Contracts.Client.IControllerAccess<C>
